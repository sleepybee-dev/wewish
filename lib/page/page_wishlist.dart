              ...
              ElevatedButton(
                onPressed: () async {
                  if (user == true) {
                    ...
                    DocumentReference<Map<String, dynamic>> registryCollection = FirebaseFirestore.instance.collection('registry')
                        .doc(curRegistryId);
                    // 기존 wishlist
                    ...
                    if (widget.registryItem == null) {
                      final ref = await FirebaseFirestore.instance.collection('registry').doc(
                          curRegistryId);
                      ref.set(data);
                    } else {
